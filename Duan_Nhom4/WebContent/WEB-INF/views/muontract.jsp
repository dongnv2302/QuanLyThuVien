...
<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>.org/TR/html4/loose.dtd">
<html>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Danh sách Mượn Trả Chi Tiết </b></h5>
...
function w3_close() {
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									<div class="container">
  <h2 style="color:#390">Thêm Mượn Trả Chi Tiết</h2>
  <form class="form-horizontal" action="/action_page.php" style="width:800px">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10" style="width:500px">         
        <input type="password" class="form-control" id="pwd" placeholder="Mã Số Sách" name="pwd">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Tiền Phạt:</label>
      <div class="col-sm-10" style="width:500px">          
        <input type="password" class="form-control" id="pwd" placeholder="Tiền Phạt" name="pwd">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Ngày Gia Hạn:</label>
      <div class="col-sm-10" style="width:500px">         
        <input type="password" class="form-control" id="pwd" placeholder="Ngày Gia Hạn" name="pwd">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Ngày Trả:</label>
      <div class="col-sm-10" style="width:500px">          
        <input type="password" class="form-control" id="pwd" placeholder="Ngày Trả" name="pwd">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Số Lần Gia Hạn:</label>
      <div class="col-sm-10" style="width:500px">          
        <input type="password" class="form-control" id="pwd" placeholder="Số Lần Gia Hạn" name="pwd">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="pwd">Ghi Chú:</label>
      <div class="col-sm-10" style="width:500px">          
        <input type="password" class="form-control" id="pwd" placeholder="Ghi Chú" name="pwd">
      </div>
    </div>
    </div>
    <div class="form-group">        
