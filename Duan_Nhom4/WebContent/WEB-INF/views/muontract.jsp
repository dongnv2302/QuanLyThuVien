...
<body class="w3-light-grey">
	...
	<div class="w3-bar w3-top w3-black w3-large" style="z-index: 4">
		...
		<span class="w3-bar-item w3-right">Xin Chào Admin&nbsp;<img
			src="../images/if_User_group_132235.png" width="24" height="24"
			alt="" /></span>
	</div>
		...
		<header class="w3-container" style="padding-top: 22px">
			...
			<a href="#" data-toggle="modal" data-target="#myModal1"
				class="offer-img"><button type="button" class="btn btn-success">
					<img src="../images/if_edit1.png" width="24" height="24" alt="" />Thêm
				</button></a>
								...
								<div class="form-group">
									...
									<div class="col-sm-10" style="width: 500px">
										<input type="email" class="form-control" id="email"
											placeholder="Mã Mượn Trả" name="email">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10" style="width: 500px">
										<input type="password" class="form-control" id="pwd"
											placeholder="Mã Số Sách" name="pwd">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2" for="pwd">Tiền
										Phạt:</label>
									<div class="col-sm-10" style="width: 500px">
										<input type="password" class="form-control" id="pwd"
											placeholder="Tiền Phạt" name="pwd">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10" style="width: 500px">
										<input type="password" class="form-control" id="pwd"
											placeholder="Ngày Gia Hạn" name="pwd">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2" for="pwd">Ngày
									...
									<div class="col-sm-10" style="width: 500px">
										<input type="password" class="form-control" id="pwd"
											placeholder="Ngày Trả" name="pwd">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2" for="pwd">Số Lần
										Gia Hạn:</label>
									<div class="col-sm-10" style="width: 500px">
										<input type="password" class="form-control" id="pwd"
											placeholder="Số Lần Gia Hạn" name="pwd">
									</div>
								</div>
								<div class="form-group">
									<label class="control-label col-sm-2" for="pwd">Ghi
										Chú:</label>
									<div class="col-sm-10" style="width: 500px">
										<input type="password" class="form-control" id="pwd"
											placeholder="Ghi Chú" name="pwd">
									</div>
								</div>
						</div>
						<div class="form-group">
