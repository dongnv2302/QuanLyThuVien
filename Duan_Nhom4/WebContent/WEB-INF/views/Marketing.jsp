...
<html>
<head>
<title>Thư Viện FPT Polytechnic | Tủ Sách Marketing</title>
...
<body>
	...
	<div class="content-top offer-w3agile">
		<div class="container ">
			<div class="spec ">
				<h3>Sách Marketing</h3>
				<div class="ser-t">
					<b></b> <span><i></i></span> <b class="line"></b>
				</div>
			</div>
			<div class=" con-w3l wthree-of">
			<c:forEach var="u" items="${marketings}">
	...
	<li class="page-item first"><a href="Marketing.poly?phantrangbtn&page=${trangdau }" class="page-link">Trang đầu</a></li>
	<li class="page-item prev"><a href="Marketing.poly?phantrangbtn&page=<c:if test="${vitrihientai==1 }">${vitrihientai }</c:if><c:if test="${vitrihientai>1 }">${vitrihientai-1 }</c:if>" class="page-link"><</a></li>
	
	<c:forEach items="${listSoLuongTrang }" var="u">
	<li class="page-item"><a <c:if test="${u == vitrihientai}">style="background-color: rgba(0,0,0,.15);"</c:if>  href="Marketing.poly?phantrangbtn&page=${u }" class="page-link">${u }</a></li>
	</c:forEach>
	
	<li class="page-item next"><a href="Marketing.poly?phantrangbtn&page=<c:if test="${vitrihientai==trangcuoi }">${vitrihientai }</c:if><c:if test="${vitrihientai<trangcuoi }">${vitrihientai+1 }</c:if>" class="page-link">></a></li>
	<li class="page-item last"><a href="Marketing.poly?phantrangbtn&page=${trangcuoi }" class="page-link">Trang cuối</a></li>
</ul>
</c:if>
		</div>
