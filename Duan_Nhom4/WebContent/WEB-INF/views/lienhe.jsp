...
<link rel="stylesheet" href="resources/css/jstarbox.css" type="text/css"
...
<body>
	...
	<div class="banner-top">
		<div class="container">
			<h3>Liên Hệ</h3>
			<h4>
				<a href="index.html">Home</a><label>/</label>Liên Hệ
			</h4>
			<div class="clearfix"></div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class=" contact-w3">
				<div class="col-md-5 contact-right">
					<img src="images/chao.png" class="img-responsive" alt="">
					<iframe
				...
				<div class="col-md-7 contact-left">
					...
					<p>Không ai sinh ra đã hoàn hảo và chúng tôi cũng vậy, Bạn có
						thể góp ý để chúng tôi hoàn thiện hơn</p>
					<ul class="contact-list">
						<li><i class="fa fa-map-marker" aria-hidden="true"></i> 137
							Nguyễn Thị Thập ,Đà Nẵng.</li>
						<li><i class="fa fa-envelope" aria-hidden="true"></i>fptpoly@example.com</a></li>
						<li><i class="fa fa-phone" aria-hidden="true"></i>+1689132259</li>
					</ul>
					<div id="container">
						<!--Horizontal Tab-->
...
<a id="foxyform_embed_link_911919" href="http://www.foxyform.com/">foxyform</a>
<script type="text/javascript">
(function(d, t){
   var g = d.createElement(t),
       s = d.getElementsByTagName(t)[0];
   g.src = "http://www.foxyform.com/js.php?id=911919&sec_hash=092b54025b7&width=350px";
...
<!-- Do not change the code! -->
								...
								<div>
									<div class="map-grid">
										...
										<ul>
											<li><i class="fa fa-arrow-right" aria-hidden="true"></i>FPT
												Polytechnic Hà Nội: Tòa nhà FPT Polytechnic (nhà H), Hàm
												Nghi, Mỹ Đình, Từ Liêm, Hà Nội</li>
											<li><i class="fa fa-arrow-right" aria-hidden="true"></i>FPT
												Polytechnic Đà Nẵng: 137, Nguyễn Thị Thập, Phường Hòa Minh,
												Quận Liên Chiểu, Đà Nẵng</li>
											<li><i class="fa fa-arrow-right" aria-hidden="true"></i>FPT
												Polytechnic Tp. Hồ Chí Minh: Cơ sở 1: 391A Nam Kỳ Khởi
												Nghĩa, Phường 7, Quận 3, TP. Hồ Chí Minh. Cơ sở 2: 778/B1
												Nguyễn Kiệm, Phường 4, Quận Phú Nhuận, TP. Hồ Chí Minh</li>
											<li><i class="fa fa-arrow-right" aria-hidden="true"></i>FPT
												Polytechnic Tây Nguyên: Số 27, tòa nhà VIB (tầng 2), Đường
												Nguyễn Tất Thành, TP. Buôn Ma Thuột, Tỉnh Đắk Lắk</li>
										</ul>
									</div>
								</div>
								<div>
									<div class="map-grid">
										...
										<ul>
											<li>Mobile No : Tư vấn 1: (024) 8582 0808
											<li>
											<li>Tư vấn 2: (024) 6684 0713
											<li>
											<li>Tư vấn 3: (024) 6684 1713
											<li>
											<li>Phòng Giáo vụ Đào tạo: (024) 6259 4013
											<li>
											<li>Phòng Dịch vụ sinh viên: (024) 6259 4713
											<li>
											<li>Phòng Công tác sinh viên: (024) 6260 4013
											<li>
											<li>Phòng Hành chính – Kế toán: (024) 6297 1413
											<li>
											<li>Phòng Quan hệ doanh nghiệp: (024) 6260 4713</li>
