...
<body>
	...
	<div class="content-top offer-w3agile">
		<div class="container ">
			...
			<c:forEach var="u" items="${tienganhs}">
	...
	<li class="page-item first"><a href="Tienganh.poly?phantrangbtn&page=${trangdau}" class="page-link">Trang đầu</a></li>
	<li class="page-item prev"><a href="Tienganh.poly?phantrangbtn&page=<c:if test="${vitrihientai==1 }">${vitrihientai }</c:if><c:if test="${vitrihientai>1 }">${vitrihientai-1 }</c:if>" class="page-link"><</a></li>
	
	<c:forEach items="${listSoLuongTrang }" var="u">
	<li class="page-item"><a <c:if test="${u == vitrihientai}">style="background-color: rgba(0,0,0,.15);"</c:if>  href="Tienganh.poly?phantrangbtn&page=${u }" class="page-link">${u }</a></li>
	</c:forEach>
	
	<li class="page-item next"><a href="Tienganh.poly?phantrangbtn&page=<c:if test="${vitrihientai==trangcuoi }">${vitrihientai }</c:if><c:if test="${vitrihientai<trangcuoi }">${vitrihientai+1 }</c:if>" class="page-link">></a></li>
	<li class="page-item last"><a href="Tienganh.poly?phantrangbtn&page=${trangcuoi }" class="page-link">Trang cuối</a></li>
</ul>
</c:if>
		</div>
