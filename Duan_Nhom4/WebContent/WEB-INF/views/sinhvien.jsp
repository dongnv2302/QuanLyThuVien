...
<input class="s" onfocus="if (this.value == 'Tìm kiếm theo MSV') {this.value = '';}" onblur="if (this.value == '') {this.value = 'Tìm kiếm theo MSV';}" type="text" name="s" value="Tìm kiếm theo MSV" />
